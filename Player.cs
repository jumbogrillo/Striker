			...
			if (Console.KeyAvailable)
			{
				...
				if (keycount < 4)
				{
					...
					if (key == ConsoleKey.LeftArrow) { Shots.Add(new Shoot(map, Width, Height, new int[] { Position[0], Position[1] }, "L", "Pl", 20, 1)); if (musica) { Music.Shoot(); } 
						if (lm_multi) { Striker.Position[0] = Position[0]; Striker.Position[1] = Position[1]; Striker.Direction = "L"; Striker.Alliance = "Pl"; Striker.Speed = 20; Striker.Damage = 1; }}
					if (key == ConsoleKey.RightArrow) { Shots.Add(new Shoot(map, Width, Height, new int[] { Position[0], Position[1] }, "R", "Pl", 20, 1)); if (musica) { Music.Shoot(); }
						if (lm_multi) { Striker.Position[0] = Position[0]; Striker.Position[1] = Position[1]; Striker.Direction = "R"; Striker.Alliance = "Pl"; Striker.Speed = 20; Striker.Damage = 1; }}
					if (key == ConsoleKey.UpArrow) { Shots.Add(new Shoot(map, Width, Height, new int[] { Position[0], Position[1] }, "U", "Pl", 20, 1)); if (musica) { Music.Shoot(); }
						if (lm_multi) { Striker.Position[0] = Position[0]; Striker.Position[1] = Position[1]; Striker.Direction = "U"; Striker.Alliance = "Pl"; Striker.Speed = 20; Striker.Damage = 1; }}
					if (key == ConsoleKey.DownArrow) { Shots.Add(new Shoot(map, Width, Height, new int[] { Position[0], Position[1] }, "D", "Pl", 20, 1)); if (musica) { Music.Shoot(); }
						if (lm_multi) { Striker.Position[0] = Position[0]; Striker.Position[1] = Position[1]; Striker.Direction = "D"; Striker.Alliance = "Pl"; Striker.Speed = 20; Striker.Damage = 1; }}

					if (key == ConsoleKey.Q) { Shots.Add(new Shoot(map, Width, Height, new int[] { Position[0], Position[1] }, "LU", "Pl", 20, 1)); if (musica) { Music.Shoot(); }
						if (lm_multi) { Striker.Position[0] = Position[0]; Striker.Position[1] = Position[1]; Striker.Direction = "LU"; Striker.Alliance = "Pl"; Striker.Speed = 20; Striker.Damage = 1; }}
					if (key == ConsoleKey.E) { Shots.Add(new Shoot(map, Width, Height, new int[] { Position[0], Position[1] }, "RU", "Pl", 20, 1)); if (musica) { Music.Shoot(); }
						if (lm_multi) { Striker.Position[0] = Position[0]; Striker.Position[1] = Position[1]; Striker.Direction = "RU"; Striker.Alliance = "Pl"; Striker.Speed = 20; Striker.Damage = 1; }}
						if (key == ConsoleKey.C) { Shots.Add(new Shoot(map, Width, Height, new int[] { Position[0], Position[1] }, "RD", "Pl", 20, 1)); if (musica) { Music.Shoot(); }
						if (lm_multi) { Striker.Position[0] = Position[0]; Striker.Position[1] = Position[1]; Striker.Direction = "RD"; Striker.Alliance = "Pl"; Striker.Speed = 20; Striker.Damage = 1; }}
					if (key == ConsoleKey.Z) { Shots.Add(new Shoot(map, Width, Height, new int[] { Position[0], Position[1] }, "LD", "Pl", 20, 1)); if (musica) { Music.Shoot(); }
						if (lm_multi) { Striker.Position[0] = Position[0]; Striker.Position[1] = Position[1]; Striker.Direction = "LD"; Striker.Alliance = "Pl"; Striker.Speed = 20; Striker.Damage = 1; }}
					if(key == ConsoleKey.P)
					{ Striker.Pause(); 
